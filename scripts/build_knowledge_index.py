...
def build_index(knowledge_dir: Path, db_path: Path, max_chars: int, overlap_chars: int) -> dict:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the local SQLite FTS5 knowledge index.")
